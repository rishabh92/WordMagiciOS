...
//        
        ...
        l.setCustom(colors: [UIColor.gray, UIColor.purple, UIColor.brown, UIColor.blue,UIColor.red,UIColor.magenta], labels: ["Not categorized","Level 1", "Level 2", "Level 3", "Level 4","Level 5"])
